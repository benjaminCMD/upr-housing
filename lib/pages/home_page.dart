  ...
  Future<List<Product>> fetchApartments() async {
    ...
    for (var doc in querySnapshot.docs) {
      ...
      Product product = Product(
        // imageUrl: data['ImageUrl'][0] ?? 'https://w7.pngwing.com/pngs/575/378/png-transparent-easter-bunny-hare-cottontail-rabbit-domestic-rabbit-european-rabbit-rabbit-mammal-image-file-formats-animals-thumbnail.png', // Default image if none is provided
          imageUrl: data['ImageUrl'] is List ? data['ImageUrl'][0] : (data['ImageUrl'] ?? 'https://w7.pngwing.com/pngs/575/378/png-transparent-easter-bunny-hare-cottontail-rabbit-domestic-rabbit-european-rabbit-rabbit-mammal-image-file-formats-animals-thumbnail.png'),
